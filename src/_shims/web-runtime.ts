...
export function getRuntime({ manuallyImported }: { manuallyImported?: boolean } = {}): Shims {
  const recommendation =
    ...
    : `Add one of these imports before your first \`import … from 'my_test_hari'\`:
...
`;
  ...
  return {
    ...
    fileFromPath: () => {
      throw new Error(
        'The `fileFromPath` function is only supported in Node. See the README for more details: https://www.github.com/hdemirev/hari-test-go-module#file-uploads',
      );
    },
